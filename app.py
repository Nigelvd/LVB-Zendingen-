...
st.title("🔐 LVB Advies Tool met Verzendtype zichtbaar")
st.markdown("Upload je Bol-export en fulfilment-export. Verzendtype ≠ LVB wordt altijd meegenomen, ongeacht benchmarkscore.")
...
if bol_file and fulfilment_file:
    ...
    for _, row in df_bol.iterrows():
        ...
        # Toon alle niet-LVB producten, ongeacht benchmark
