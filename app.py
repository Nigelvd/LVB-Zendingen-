...
with tab1:
    ...
    gebruik_14_dagen = st.checkbox("📆 Stuur op basis van 14 dagen in plaats van 28 dagen")
    if gebruik_14_dagen:
    ...
    if bol_file and fulfilment_file:
        ...
        # Voeg 14-dagen verkopen toe indien geselecteerd
        if gebruik_14_dagen and bol_14_file:
            df_14 = pd.read_excel(bol_14_file, usecols=[0, 8], dtype=str)
